...
class ConflictWithProductQuantity extends Error {
    customMessage: string
    customCode: number
    constructor() {
        super();
        this.customMessage = "Conflict with product quantity"
        this.customCode = 409
    }
}
...
export {ConflictWithProductQuantity,CartNotFoundError, ProductInCartError, ProductNotInCartError, WrongUserCartError, EmptyCartError}