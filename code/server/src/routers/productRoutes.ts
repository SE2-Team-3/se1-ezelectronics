...
class ProductRoutes {
    ...
    initRoutes() {
        ...
        this.router.post(
            ...
            body('arrivalDate').optional().isString().notEmpty().matches(/^\d{4}-\d{2}-\d{2}$/),
        ...
        this.router.patch(
            ...
            this.authenticator.isAdminOrManager,
            body('quantity').isInt({ min: 1 }),
            body('changeDate').optional().isString().notEmpty().matches(/^\d{4}-\d{2}-\d{2}$/),
            this.errorHandler.validateRequest,
        ...
        this.router.patch(
            ...
            this.authenticator.isAdminOrManager,
            body('quantity').isInt({ min: 1 }),
            body('sellingDate').optional().isString().notEmpty().matches(/^\d{4}-\d{2}-\d{2}$/),
            this.errorHandler.validateRequest,
